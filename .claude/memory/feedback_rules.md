...
8b. **Never use "god" as a casual technical label** (no "god object", "god file", "god class"). Abdallah is religious — God is holy, not a throwaway joke. Say "oversized file", "catch-all module", "monolith", "does-too-much class" instead. Corrected 2026-07-08.

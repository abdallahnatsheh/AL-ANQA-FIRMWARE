# Al-Anqa — netspy & isoscan Feature Plan
...
```
┌─────────────────────────────────────┐
│ AL-ANQA // NET SPY           [q] exit │  ← RED header
├─────────────────────────────────────┤
...
```
┌─────────────────────────────────────┐
│ AL-ANQA // ISO SCAN          [q] exit │  ← RED header
├─────────────────────────────────────┤
...
- `al-anqa-firmware/attacks/netspy.cpp/.h`
- `al-anqa-firmware/attacks/isoscan.cpp/.h`
- `al-anqa-firmware/attacks/iso_common.cpp/.h` — shared GTK, MAC spoof utils

## Files to Modify

- `al-anqa-firmware/shell.cpp` — register netspy/ns and isoscan/is
...
Al-Anqa implements these techniques independently from scratch

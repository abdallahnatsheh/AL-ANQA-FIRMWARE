...
`/apps/isoscan/NNN.pcap` — `is portdown` victim frame capture (linktype 105, Wireshark) + `dns_NNN.csv` (`is dns` logged DNS queries: `time_ms,src_ip,query`) (`SD_DIR_ISOSCAN`)

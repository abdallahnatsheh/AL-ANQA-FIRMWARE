...
- Async scan — the screen and keys stay responsive during each sweep
...
1a:2b:3c:4d:5e:6f,MyWiFi,[WPA2-PSK-CCMP][ESS],2026-06-20 14:30:00,6,-55,40.123456,-74.123456,0,8.0,WIFI
```
...
| AltitudeMeters | `0` (GPS altitude not currently exposed) |
| AccuracyMeters | estimate from satellite count (8 m if ≥6 sats, else 20 m) |
| Type | always `WIFI` |

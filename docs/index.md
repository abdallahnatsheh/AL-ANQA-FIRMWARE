...
- [WiFi Attacks](wifi-attacks)
  ...
  - [Pwnagotchi Pet](pwn) — `pwn` / `pw` — autonomous **AI-adaptive roam** (13ch; `basic`=1/6/11) + capture handshakes/PMKIDs (clientless solicit) + **on-device crack** (active/stealth/passive)

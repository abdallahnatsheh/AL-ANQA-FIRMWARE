...
| [حيوان Pwnagotchi]({{ site.baseurl }}/pwn) | `pwn` / `pw` | ذاتي — **تجوّل AI تكيّفي** (كل الـ13 قناة؛ `basic`=1/6/11) + التقاط مصافحات/PMKID (استدرار بلا عميل) + **كسر على الجهاز** (نشط/خفي/سلبي)؛ **يعمل بلا بطاقة** (كسر في الذاكرة ← حفظ في NVS) + **مشاركة بيانات الاعتماد المكسورة عبر الشبكة** |

...
- **راقبه مباشرةً:** بمجرّد تشغيل كسر في الخلفية، تفتح `cc` أو `cc bg` شاشة مراقبة حيّة (المحاولات، المعدّل، التخمين الحالي). **`[q]` يغادر المراقبة دون إيقاف الكسر** — يواصل الطحن في الخلفية. (لبدء كسر أمامي *جديد* بينما يعمل واحد في الخلفية، مرّر ملفًّا: `cc <cap>`.)

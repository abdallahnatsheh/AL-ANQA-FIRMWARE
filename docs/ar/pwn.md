...
يستخدم إطار beacon خاص (وليس مكتبات ESP-NOW) يُستقبل في مُلتقط pwn نفسه — دون إعداد راديو إضافي. تُبَثّ التحية **عبر كل القنوات الـ13** في كل دورة، فيجد الحيوانان أحدهما الآخر مهما كانت القنوات التي يتجوّلان عليها (دون حاجة لمزامنة القنوات).
...
> ✅ **تم التحقق على العتاد (جهازان).** أُكِّد الاكتشاف المتبادل، وأسماء الأقران، وعدّاد `g1`، والالتقاء عبر قنوات مختلفة، ومشاركة بيانات الاعتماد من جهاز بلا بطاقة إلى جهاز ببطاقة — كلها على عتاد حقيقي.

...
AL-ANQA firmware tree (compiled as project sources; see NOTICES #20 for why it is
...
The code here is Shim06's work under GPL-3.0. AL-ANQA's own integration layer
...
bus.cpp save/load-state path moved from /states to /apps/nes/states (grouped
under the emulator's SD folder). All other core files (CPU, PPU, APU, mappers
0-4+069) are upstream verbatim.

Because this core is GPL-3.0 and is distributed as part of AL-ANQA, the combined

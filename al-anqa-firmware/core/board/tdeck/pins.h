/**
 * @file      pins.h  (T-Deck / T-Deck-Plus variant)
 * @author    Lewis He (lewishe@outlook.com)
 * @license   MIT
 * @copyright Copyright (c) 2023  Shenzhen Xin Yuan Electronic Technology Co., Ltd
 * @date      2023-04-11
 *
 * T-Deck pin map. Extracted verbatim from the original core/system/utilities.h
 * into the board layer (core/board/) so the T-Pager can supply its own pins.h
 * without touching app code. utilities.h now forwards here via board.h.
 */
#pragma once

...
static const ArgHintEntry kArgHints[] = {
    ...
    { "mc",          "restore",       "on off" },
    // undercover / uc
    { "undercover",  "",              "set clear status boot panic" },
    { "uc",          "",              "set clear status boot panic" },
    { "undercover",  "boot",          "on off" },
    { "uc",          "boot",          "on off" },
    { "undercover",  "panic",         "set off" },
    { "uc",          "panic",         "set off" },
    // wguard / wg
    { "wguard",      "",              "stop view" },
    { "wg",          "",              "stop view" },
...
void CommandManager::setupCommands() {
    ...
    registerCommand("info",        "inf",    [](char* a) { espInfoPrinter.printESPInfo(); },                                 "Device info + project QR (SYS/RADIO/HW/ABOUT)", false, "System");
    ...
    registerCommand("dpwo",         "dw",     [](char* a) { runDpwo(a); },                                                     "[EXP] Default-password check: dw <ip|nd#|ns#> [port|service]", true, "Network");

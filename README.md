...
| `arpspoof` | `as` | `<victim> [gw]` | **[EXP]** ARP cache poisoning (redirect/DoS, heals on exit) — victim = ip/nd#/ns# |
| `responder` | `rsp` | — | **[EXP]** LLMNR/NBT-NS poisoner + NetNTLMv2 capture → SD (hashcat -m 5600) |

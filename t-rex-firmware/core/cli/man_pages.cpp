...
static const ManEntry PAGES[] = {
    ...
    { "wps", "wps", {
        ...
        "           AP-SETUP-LOCKED, methods, and the",
        "           leaked mfr/model/device name",
        "         - computes a candidate PIN",
        "         - LIVE-sniffs the WPS EAP-WSC handshake",
        "           (M1/M2/M3) and dumps it pixiewps-ready",
        "         [p] = WPS push-button connect (SSID+PSK)",
        "         [q] = stop",
        "",
        "OUT      /apps/wps/wps.csv, pixie_NNN.txt (crack",
        "         w/ pixiewps offline), creds.csv (pbc)",

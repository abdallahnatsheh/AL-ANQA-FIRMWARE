...
static const ManEntry PAGES[] = {
    ...
    { "usbexec", "ux", {
        ...
        "         'ble clone <mac|#>' = BLESA: spoof",
        "         a bonded kbd (# from sbl scan) so a",
        "         host auto-reconnects. Needs the real",
        "         device off + a non-re-auth host [EXP].",
        "         'ble name \"X\"' = fake advertised name",
        "         (both modes; quotes for spaces).",
        "         Same DuckyScript for all.",
        "",

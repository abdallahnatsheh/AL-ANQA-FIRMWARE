...
static const ManEntry PAGES[] = {
    ...
    { "usbexec", "ux", {
        ...
        "         Dispatch log saved to keylog/ after exit.",
        "",
        "LOG      USB HOST keylogger. Plug victim keyboard",
        "         into T-Deck USB port (T-Deck = host).",
        "         'ux log'     = log only; q=stop.",
        "         'ux log ble' = also BLE-forward to PC",
        "         (keyboard still works transparently).",
        "         Saved to /apps/badusb/keylog/NNN.txt.",
        "",
